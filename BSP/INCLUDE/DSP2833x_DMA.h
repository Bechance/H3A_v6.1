...
// Channel MODE register bit definitions:
	...
	{
Uint16 PERINTSEL:
		5;       // 4:0    Peripheral Interrupt and Sync Select Bits (R/W):
		//        0     no interrupt
		//        1     SEQ1INT & ADCSYNC
		//        2     SEQ2INT
		//        3     XINT1
...
Uint16 RUN:
		1;             // 0      Run Bit (R=0/W=1)
Uint16 HALT:
		1;            // 1      Halt Bit (R=0/W=1)
Uint16 SOFTRESET:
		1;       // 2      Soft Reset Bit (R=0/W=1)
Uint16 PERINTFRC:
		1;       // 3      Interrupt Force Bit (R=0/W=1)
Uint16 PERINTCLR:
		1;       // 4      Interrupt Clear Bit (R=0/W=1)
Uint16 SYNCFRC:
		1;         // 5      Sync Force Bit (R=0/W=1)
Uint16 SYNCCLR:
		1;         // 6      Sync Clear Bit (R=0/W=1)
Uint16 ERRCLR:
		1;          // 7      Error Clear Bit (R=0/W=1)
Uint16 PERINTFLG:
		1;       // 8      Interrupt Flag Bit (R):
...
// DMACTRL register bit definitions:
	...
	{
Uint16 HARDRESET:
		1;       // 0      Hard Reset Bit (R=0/W=1)
Uint16 PRIORITYRESET:
		1;   // 1      Priority Reset Bit (R=0/W=1)
Uint16 rsvd1:
		14;          // 15:2   (R=0:0)
	};
...
// PRIORITYSTAT register bit definitions:
	...
	{
Uint16 ACTIVESTS:
		3;        // 2:0    Active Channel Status Bits (R):
...
Uint16 rsvd1:
		1;            // 3      (R=0)
Uint16 ACTIVESTS_SHADOW:
		3; // 6:4    Active Channel Status Shadow Bits (R):
