...
/*   FLASHD      : origin = 0x320000, length = 0x008000 */    /* on-chip FLASH */
 ...
 /*  FLASHA      : origin = 0x338000, length = 0x007F80*/     /* on-chip FLASH */
   ...
   list_head     : origin = 0x140100, length = 0x10
   mod_list      : origin = 0x140110, length = 0x190
   DR_list_head  : origin = 0x140300, length = 0x10
   DR_list       : origin = 0x140310, length = 0x190
 
   FLASHA      : origin = 0x140500, length = 0x035B00
   CSM_RSVD    : origin = 0x336F80, length = 0x000076     /* Part of FLASHA.  Program with all 0x0000 when CSM is in use. */
   BEGIN       : origin = 0x140000, length = 0x000002     /* Part of FLASHA.  Used for "boot to Flash" bootloader mode. */
...
PAGE 1 :   /* Data Memory */
   ...
   SRAM	       : origin = 0x100000, length = 0x3f000      /*外部ram 384k*/
