...
void xintf_zone6and7_timing(void)
{
    ...
    XintfRegs.XTIMING0.bit.USEREADY = 2;
    ...
    XintfRegs.XTIMING6.bit.XWRACTIVE = 1;//2;
    XintfRegs.XTIMING6.bit.XWRTRAIL = 0;//1;
    // Zone read timing
    XintfRegs.XTIMING6.bit.XRDLEAD = 1;
    XintfRegs.XTIMING6.bit.XRDACTIVE = 1;//2;
    XintfRegs.XTIMING6.bit.XRDTRAIL = 0;//1;
    ...
    XintfRegs.XTIMING6.bit.READYMODE = 0;//1;  // sample asynchronous
    // Size must be either:
    // 0,1 = x32 or
    // 1,1 = x16 other values are reserved
    ...
    // Zone will sample XREADY signal
    XintfRegs.XTIMING7.bit.USEREADY = 2;
