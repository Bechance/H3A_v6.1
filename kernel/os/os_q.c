...
#if OS_Q_ACCEPT_EN > 0
#pragma CODE_SECTION(OSQAccept,"ramfuncs")
...
*********************************************************************************************************
*/
#pragma CODE_SECTION(OSQCreate,"ramfuncs")
...
#if OS_Q_DEL_EN > 0
#pragma CODE_SECTION(OSQDel,"ramfuncs")

// CODE_SECTION(OSQDel,".UserProgramCode")
...
#if OS_Q_FLUSH_EN > 0
// CODE_SECTION(OSQFlush,".UserProgramCode")
...
#pragma CODE_SECTION(OSQPend,"ramfuncs")
...
#pragma CODE_SECTION(OSQPendAbort,"ramfuncs")
...
#if OS_Q_POST_EN > 0
#pragma CODE_SECTION(OSQPost,"ramfuncs")
...
// CODE_SECTION(OSQPostOpt,".UserProgramCode")
...
#if OS_Q_QUERY_EN > 0
// CODE_SECTION(OSQQuery,".UserProgramCode")
...
// CODE_SECTION(OS_QInit,".UserProgramCode")
void  OS_QInit( void )
{
#if OS_MAX_QS == 1
