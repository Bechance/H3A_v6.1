...
*                                             CORE FUNCTIONS
*
*                              (c) Copyright 1992-2007, Micrium, Weston, m_file
*                                           All Rights Reserved
*
* File    : OS_CORE.C
* By      : Jean J. Labrosse
...
#pragma CODE_SECTION(OSEventPendMulti,"ramfuncs")
...
*********************************************************************************************************
*/
#pragma CODE_SECTION(OSIntEnter,"ramfuncs")
...
*********************************************************************************************************
*/
#pragma CODE_SECTION(OSIntExit,"ramfuncs")
...
#pragma CODE_SECTION(OSSchedLock,"ramfuncs")
...
#if OS_SCHED_LOCK_EN > 0
#pragma CODE_SECTION(OSSchedUnlock,"ramfuncs")
...
#pragma CODE_SECTION(OSTimeTick,"ramfuncs")
...
*/
#if (OS_EVENT_EN)
#pragma CODE_SECTION(OS_EventTaskRdy,"ramfuncs")
...
*/
#if (OS_EVENT_EN)
#pragma CODE_SECTION(OS_EventTaskWait,"ramfuncs")
...
*/
#if ((OS_EVENT_EN) && (OS_EVENT_MULTI_EN > 0))
#pragma CODE_SECTION(OS_EventTaskWaitMulti,"ramfuncs")
...
*/
#if (OS_EVENT_EN)
#pragma CODE_SECTION(OS_EventTaskRemove,"ramfuncs")
...
*/
#if ((OS_EVENT_EN) && (OS_EVENT_MULTI_EN > 0))
#pragma CODE_SECTION(OS_EventTaskRemoveMulti,"ramfuncs")
...
*********************************************************************************************************
*/
#pragma CODE_SECTION(OS_MemClr,"ramfuncs")
...
*********************************************************************************************************
*/
#pragma CODE_SECTION(OS_MemCopy,"ramfuncs")
...
*********************************************************************************************************
*/
#pragma CODE_SECTION(OS_Sched,"ramfuncs")
...
*********************************************************************************************************
*/
#pragma CODE_SECTION(OS_SchedNew,"ramfuncs")
static  void  OS_SchedNew( void )
{
...
*********************************************************************************************************
*/
#pragma CODE_SECTION(OS_StrCopy,"ramfuncs")
...
*********************************************************************************************************
*/
#pragma CODE_SECTION(OS_StrLen,"ramfuncs")
...
*********************************************************************************************************
*/
#pragma CODE_SECTION(OS_TaskIdle,"ramfuncs")

void  OS_TaskIdle( void *p_arg )
{
#if OS_CRITICAL_METHOD == 3                      /* Allocate storage for CPU status register           */
	OS_CPU_SR  cpu_sr = 0;ÿ
#endif
