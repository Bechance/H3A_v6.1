...
// CODE_SECTION(OSTimeDly,".UserProgramCode")
...
// CODE_SECTION(OSTimeDlyHMSM,".UserProgramCode")
...
// CODE_SECTION(OSTimeGet,".UserProgramCode")
...
#if OS_TIME_GET_SET_EN > 0
// CODE_SECTION(OSTimeSet,".UserProgramCode")
