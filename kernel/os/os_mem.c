...
// CODE_SECTION(OSMemGet,".UserProgramCode")
...
// CODE_SECTION(OSMemNameGet,".UserProgramCode")
...
#if OS_MEM_NAME_SIZE > 1
// CODE_SECTION(OSMemNameSet,".UserProgramCode")
...
// CODE_SECTION(OSMemPut,".UserProgramCode")
...
// CODE_SECTION(OSMemQuery,".UserProgramCode")
