...
// CODE_SECTION(OSTaskChangePrio,".UserProgramCode")
...
// CODE_SECTION(OSTaskCreate,".UserProgramCode")
...
/*$PAGE*/
#if OS_TASK_DEL_EN > 0
// CODE_SECTION(OSTaskDelReq,".UserProgramCode")
...
#if OS_TASK_NAME_SIZE > 1
// CODE_SECTION(OSTaskNameGet,".UserProgramCode")
...
*/
#if OS_TASK_NAME_SIZE > 1
// CODE_SECTION(OSTaskNameSet,".UserProgramCode")
...
// CODE_SECTION(OSTaskStkChk,".UserProgramCode")
...
#if OS_TASK_SUSPEND_EN > 0
// CODE_SECTION(OSTaskSuspend,".UserProgramCode")
...
*/
#if (OS_TASK_STAT_STK_CHK_EN > 0) && (OS_TASK_CREATE_EXT_EN > 0)
// CODE_SECTION(OS_TaskStkClr,".UserProgramCode")
