...
#if OS_TMR_EN > 0
// CODE_SECTION(OSTmrCreate,".UserProgramCode")
...
#if OS_TMR_EN > 0
// CODE_SECTION(OSTmrDel,".UserProgramCode")
...
// CODE_SECTION(OSTmrNameGet,".UserProgramCode")
...
#if OS_TMR_EN > 0
// CODE_SECTION(OSTmrRemainGet,".UserProgramCode")
...
#if OS_TMR_EN > 0
// CODE_SECTION(OSTmrStateGet,".UserProgramCode")
...
#if OS_TMR_EN > 0
// CODE_SECTION(OSTmrStart,".UserProgramCode")
...
#if OS_TMR_EN > 0
// CODE_SECTION(OSTmrStop,".UserProgramCode")
...
#if OS_TMR_EN > 0
// CODE_SECTION(OSTmrSignal,".UserProgramCode")
...
#if OS_TMR_EN > 0
// CODE_SECTION(OSTmr_Alloc,".UserProgramCode")
static  OS_TMR  *OSTmr_Alloc( void )
{
	OS_TMR *ptmr;
...
#if OS_TMR_EN > 0
// CODE_SECTION(OSTmr_Free,".UserProgramCode")
static  void  OSTmr_Free( OS_TMR *ptmr )
{
...
#if OS_TMR_EN > 0
// CODE_SECTION(OSTmr_Init,".UserProgramCode")
...
#if OS_TMR_EN > 0
// CODE_SECTION(OSTmr_InitTask,".UserProgramCode")
static  void  OSTmr_InitTask( void )
{
...
#if OS_TMR_EN > 0
// CODE_SECTION(OSTmr_Link,".UserProgramCode")
static  void  OSTmr_Link( OS_TMR *ptmr, INT8U type )
{
	OS_TMR       *ptmr1;
	OS_TMR_WHEEL *pspoke;
...
#if OS_TMR_EN > 0
// CODE_SECTION(OSTmr_Unlink,".UserProgramCode")
static  void  OSTmr_Unlink( OS_TMR *ptmr )
{
	OS_TMR        *ptmr1;
	OS_TMR        *ptmr2;
...
#if OS_TMR_EN > 0
// CODE_SECTION(OSTmr_Lock,".UserProgramCode")
static  void  OSTmr_Lock( void )
{
	INT8U  err;
...
#if OS_TMR_EN > 0
// CODE_SECTION(OSTmr_Unlock,".UserProgramCode")
static  void  OSTmr_Unlock( void )
{
...
#if OS_TMR_EN > 0
// CODE_SECTION(OSTmr_Task,".UserProgramCode")
static  void  OSTmr_Task( void *p_arg )
{
	INT8U            err;
	OS_TMR          *ptmr;
