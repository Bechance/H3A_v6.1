...
*********************************************************************************************/
// CODE_SECTION(OSMutexCreate,".UserProgramCode")
...
#if OS_MUTEX_DEL_EN
// CODE_SECTION(OSMutexDel,".UserProgramCode")
...
// CODE_SECTION(OSMutexPend,".UserProgramCode")
...
// CODE_SECTION(OSMutexPost,".UserProgramCode")
...
// CODE_SECTION(OSMutexQuery,".UserProgramCode")
...
// CODE_SECTION(OSMutex_RdyAtPrio,".UserProgramCode")
static  void  OSMutex_RdyAtPrio( OS_TCB *ptcb, INT8U prio )
{
	INT8U   y;
