...
void app_startmod_insmod( void )
{
	...
	app_startmod_resource_init();	/*初始化本模块资源*/
	app_startmod_fun_entry();    	/*本模块主功能入口*/
	DBGMSG( "startmod....\n", LOG_NP, LOG_NP );
	return;
}
/********************************************************************
...
{
	app_startmod_fun_exit();					/*退出本模块主功能*/
...
Bsize_t app_startmod_add( void )
{
	...
	Bsize_t mod_id;
	temp.insmod_fun = app_startmod_insmod;/*模块入口*/
	temp.exitmod_fun = app_startmod_exit;/*模块出口*/
