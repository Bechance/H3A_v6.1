...
void app_USBmod_insmod( void )
{
	...
	app_USBmod_resource_init();/*初始化本模块资源*/
	app_USBmod_fun_entry();    /*本模块主功能入口*/
...
Bsize_t app_USBmod_add( void )
{
	...
	Bsize_t mod_id;
	temp.insmod_fun = app_USBmod_insmod;/*模块入口*/
	temp.exitmod_fun = app_USBmod_exit;/*模块出口*/
