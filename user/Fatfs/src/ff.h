...
#define f_size(fp) ((fp)->fsize)
	...
	/* Sync functions */
#if _FS_REENTRANT
	unsigned char  ff_cre_syncobj( BYTE, _SYNC_t* );/* Create a sync object */
	unsigned char ff_req_grant( _SYNC_t );			/* Lock sync object */
	void  ff_rel_grant( _SYNC_t );		/* Unlock sync object */
	unsigned char ff_del_syncobj( _SYNC_t );		/* Delete a sync object */
#endif
